      ...
      <div id="home">
        ...
        <div class="row-fluid marketing">
          <div class="span6">
						<?php 
							if ($_SERVER['PHP_AUTH_USER']) {
								print("<h4>Authentication</h4>");
								print("<p>");
								print("<b>User: </b>".$_SERVER['PHP_AUTH_USER']."<br>");
								print("</p>");
							} else {
								print("<h4>Authentication</h4>");
								print("<p>");
								print("<b>User: </b>No user<br>");
								print("</p>");
							}
          ...
          <div class="span6">
            ...
            <iframe src="https://ghbtns.com/github-btn.html?user=fisherinnovation&repo=CronWeb&type=fork&count=true&size=large"
  allowtransparency="true" frameborder="0" scrolling="0" width="130" height="30"></iframe>

            <iframe src="https://ghbtns.com/github-btn.html?user=fisherinnovation&repo=CronWeb&type=watch&count=true&size=large"
  allowtransparency="true" frameborder="0" scrolling="0" width="170" height="30"></iframe>
            <br>
  <iframe src="https://ghbtns.com/github-btn.html?user=fisherinnovation&repo=CronWeb&type=follow&count=true&size=large"
